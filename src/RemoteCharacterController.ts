...
import RemoteChannel from "./agora/RemoteChannel";
...
export class RemoteCharacterController {
    ...
    constructor(avatar: Mesh, scene: Scene, id, roomid) {
        ...
        this._remoteChannel = new RemoteChannel();
    ...
    drawEllipsoid(mesh) {
        ...
        ellipsoid.actionManager.registerAction(
            new BABYLON.ExecuteCodeAction(
                ...
                () => {
                    this._remoteChannel.join(this._roomid+this._id)
        ...
        ellipsoid.actionManager.registerAction(
            new BABYLON.ExecuteCodeAction(
                ...
                () => {
                    this._remoteChannel.leave(this._roomid+this._id)
    ...
    setColor(rgb){
       ...
       let b : BABYLON.PBRMaterial = this._avatar.getChildMeshes()[1].material.clone(`skin_${this._id}`)
       a.albedoColor = color
       b.albedoColor = color
